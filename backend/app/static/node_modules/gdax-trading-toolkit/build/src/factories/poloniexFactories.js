...
const PoloniexExchangeAPI_1 = require("../exchanges/poloniex/PoloniexExchangeAPI");
...
function DefaultAPI(logger) {
    if (!publicAPIInstance) {
        publicAPIInstance = new PoloniexExchangeAPI_1.PoloniexExchangeAPI({
            logger: logger,
            auth: {
...
function getChannelId(product, info) {
    ...
    for (const id in info) {
        ...
        const found = (symbol === (PoloniexCommon_1.PRODUCT_MAP[product] || product)) || (symbol === PoloniexCommon_1.gdaxToPolo(product));
